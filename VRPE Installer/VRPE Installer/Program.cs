...
namespace VRPE_Installer
{
    internal static class Program
    {
        ...
        private static void UnhandledException(object sender, UnhandledExceptionEventArgs e)
        {
            ...
            FlexibleMessageBox.Show($"Exception Message: {message}", "Error during runtime!", MessageBoxButtons.OK,
        ...
        private static void UnhandledUIException(object sender, ThreadExceptionEventArgs e)
        {
            ...
            FlexibleMessageBox.Show($"Exception Message: {ex.Message}", "Error during runtime!", MessageBoxButtons.OK,
            MessageBoxIcon.Warning);
        }
