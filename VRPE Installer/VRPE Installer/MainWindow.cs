...
namespace VRPE_Installer
{
    public partial class MainWindow : Form
    {
        ...
        {
            themeChangerButton.Hide(); flowPanel.Show(); wikiLink.Hide(); welcomeLabel.Hide(); backButton.Show(); nextButton.Hide(); rookieButton.Show(); vrpguiButton.Show(); shortcutmakerButton.Show();
            if (RookiePathExists)
            {
        ...
        {
            themeChangerButton.Show(); flowPanel.Hide(); wikiLink.Show(); backButton.Hide(); nextButton.Show(); welcomeLabel.Show(); rookieButton.Hide(); vrpguiButton.Hide(); shortcutmakerButton.Hide();
            if (RookiePathExists)
            {
        ...
        {
            bool success;
            var neededIcon = "https://vrpirates.wiki/downloads/rookie.ico";
            var RSLPATH = @"C:\RSL\";
        ...
        {
            bool success;
            var neededIcon = "https://vrpirates.wiki/downloads/rclone.ico";
            var RSLPATH = @"C:\RSL\";
        ...
        {
            bool success;
            var neededIcon = "https://vrpirates.wiki/downloads/sm.ico";
            var RSLPATH = @"C:\RSL\";
        ...
        {
            System.Diagnostics.Process.Start("https://vrpirates.wiki/");
        }
        ...
        private void MainWindow_Shown(object sender, EventArgs e) { var lightrgbhoverbuttons = System.Drawing.Color.FromArgb(((int)(((byte)(234)))), ((int)(((byte)(234)))), ((int)(((byte)(234))))); var darkrgbhoverbuttons = System.Drawing.Color.FromArgb(((int)(((byte)(54)))), ((int)(((byte)(54)))), ((int)(((byte)(54))))); var lightrgbbuttons = System.Drawing.Color.FromArgb(((int)(((byte)(204)))), ((int)(((byte)(204)))), ((int)(((byte)(204))))); var lightrgbpanels = System.Drawing.Color.FromArgb(((int)(((byte)(224)))), ((int)(((byte)(224)))), ((int)(((byte)(224))))); var darkrgbpanels = System.Drawing.Color.FromArgb(((int)(((byte)(14)))), ((int)(((byte)(14)))), ((int)(((byte)(14))))); var darkrgbbuttons = System.Drawing.Color.FromArgb(((int)(((byte)(34)))), ((int)(((byte)(34)))), ((int)(((byte)(34))))); Updater.Update(); if (!Properties.Settings.Default.lightModeEnabled) { themeChangerButton.Text = "LIGHT MODE"; this.BackgroundImage = Properties.Resources.backgrounddark; backButton.Active1 = darkrgbhoverbuttons; backButton.Active2 = darkrgbhoverbuttons; nextButton.Active1 = darkrgbhoverbuttons; nextButton.Active2 = darkrgbhoverbuttons; rookieButton.Active1 = darkrgbhoverbuttons; rookieButton.Active2 = darkrgbhoverbuttons; vrpguiButton.Active1 = darkrgbhoverbuttons; vrpguiButton.Active2 = darkrgbhoverbuttons; shortcutmakerButton.Active1 = darkrgbhoverbuttons; shortcutmakerButton.Active2 = darkrgbhoverbuttons; themeChangerButton.Active1 = darkrgbhoverbuttons; themeChangerButton.Active2 = darkrgbhoverbuttons; LaunchRookie.Active1 = darkrgbhoverbuttons; LaunchRookie.Active2 = darkrgbhoverbuttons; rookiePathOpen.Active1 = darkrgbhoverbuttons; rookiePathOpen.Active2 = darkrgbhoverbuttons; backButton.Inactive1 = darkrgbbuttons; backButton.Inactive2 = darkrgbbuttons; backButton.ForeColor = Color.White; nextButton.Inactive1 = darkrgbbuttons; nextButton.Inactive2 = darkrgbbuttons; nextButton.ForeColor = Color.White; rookieButton.Inactive1 = darkrgbbuttons; rookieButton.Inactive2 = darkrgbbuttons; rookieButton.ForeColor = Color.White; vrpguiButton.Inactive1 = darkrgbbuttons; vrpguiButton.Inactive2 = darkrgbbuttons; vrpguiButton.ForeColor = Color.White; shortcutmakerButton.Inactive1 = darkrgbbuttons; shortcutmakerButton.Inactive2 = darkrgbbuttons; shortcutmakerButton.ForeColor = Color.White; themeChangerButton.Inactive1 = darkrgbbuttons; themeChangerButton.Inactive2 = darkrgbbuttons; themeChangerButton.ForeColor = Color.White; LaunchRookie.Inactive1 = darkrgbbuttons; LaunchRookie.Inactive2 = darkrgbbuttons; LaunchRookie.ForeColor = Color.White; rookiePathOpen.Inactive1 = darkrgbbuttons; rookiePathOpen.Inactive2 = darkrgbbuttons; rookiePathOpen.ForeColor = Color.White; minimizeButton.BackColor = darkrgbbuttons; closeButton.BackColor = darkrgbbuttons; minimizeButton.ForeColor = Color.White; closeButton.ForeColor = Color.White; contentPanel.BackColor = darkrgbpanels; titleBar.BackColor = darkrgbpanels; contentPanel.ForeColor = Color.White; label1.ForeColor = Color.White; welcomeLabel.ForeColor = Color.White; wikiLink.LinkColor = Color.White; rookiePathLabel.ForeColor = Color.White; } if (Properties.Settings.Default.lightModeEnabled) { themeChangerButton.Text = "DARK MODE"; this.BackgroundImage = Properties.Resources.backgroundlight; backButton.Active1 = lightrgbhoverbuttons; backButton.Active2 = lightrgbhoverbuttons; nextButton.Active1 = lightrgbhoverbuttons; nextButton.Active2 = lightrgbhoverbuttons; rookieButton.Active1 = lightrgbhoverbuttons; rookieButton.Active2 = lightrgbhoverbuttons; vrpguiButton.Active1 = lightrgbhoverbuttons; vrpguiButton.Active2 = lightrgbhoverbuttons; shortcutmakerButton.Active1 = lightrgbhoverbuttons; shortcutmakerButton.Active2 = lightrgbhoverbuttons; themeChangerButton.Active1 = lightrgbhoverbuttons; themeChangerButton.Active2 = lightrgbhoverbuttons; LaunchRookie.Active1 = lightrgbhoverbuttons; LaunchRookie.Active2 = lightrgbhoverbuttons; rookiePathOpen.Active1 = lightrgbhoverbuttons; rookiePathOpen.Active2 = lightrgbhoverbuttons; backButton.Inactive1 = lightrgbbuttons; backButton.Inactive2 = lightrgbbuttons; backButton.ForeColor = Color.Black; nextButton.Inactive1 = lightrgbbuttons; nextButton.Inactive2 = lightrgbbuttons; nextButton.ForeColor = Color.Black; rookieButton.Inactive1 = lightrgbbuttons; rookieButton.Inactive2 = lightrgbbuttons; rookieButton.ForeColor = Color.Black; vrpguiButton.Inactive1 = lightrgbbuttons; vrpguiButton.Inactive2 = lightrgbbuttons; vrpguiButton.ForeColor = Color.Black; shortcutmakerButton.Inactive1 = lightrgbbuttons; shortcutmakerButton.Inactive2 = lightrgbbuttons; shortcutmakerButton.ForeColor = Color.Black; themeChangerButton.Inactive1 = lightrgbbuttons; themeChangerButton.Inactive2 = lightrgbbuttons; themeChangerButton.ForeColor = Color.Black; LaunchRookie.Inactive1 = lightrgbbuttons; LaunchRookie.Inactive2 = lightrgbbuttons; LaunchRookie.ForeColor = Color.Black; rookiePathOpen.Inactive1 = lightrgbbuttons; rookiePathOpen.Inactive2 = lightrgbbuttons; rookiePathOpen.ForeColor = Color.Black; minimizeButton.BackColor = lightrgbbuttons; closeButton.BackColor = lightrgbbuttons; minimizeButton.ForeColor = Color.Black; closeButton.ForeColor = Color.Black; contentPanel.BackColor = lightrgbpanels; titleBar.BackColor = lightrgbpanels; contentPanel.ForeColor = Color.Black; label1.ForeColor = Color.Black; welcomeLabel.ForeColor = Color.Black; wikiLink.LinkColor = Color.Black; rookiePathLabel.ForeColor = Color.Black; } }

        private void themeChangerButton_Click(object sender, EventArgs e) { var lightrgbhoverbuttons = System.Drawing.Color.FromArgb(((int)(((byte)(234)))), ((int)(((byte)(234)))), ((int)(((byte)(234))))); var darkrgbhoverbuttons = System.Drawing.Color.FromArgb(((int)(((byte)(54)))), ((int)(((byte)(54)))), ((int)(((byte)(54))))); var lightrgbbuttons = System.Drawing.Color.FromArgb(((int)(((byte)(204)))), ((int)(((byte)(204)))), ((int)(((byte)(204))))); var lightrgbpanels = System.Drawing.Color.FromArgb(((int)(((byte)(224)))), ((int)(((byte)(224)))), ((int)(((byte)(224))))); var darkrgbpanels = System.Drawing.Color.FromArgb(((int)(((byte)(14)))), ((int)(((byte)(14)))), ((int)(((byte)(14))))); var darkrgbbuttons = System.Drawing.Color.FromArgb(((int)(((byte)(34)))), ((int)(((byte)(34)))), ((int)(((byte)(34))))); if (!Properties.Settings.Default.lightModeEnabled) { Properties.Settings.Default.lightModeEnabled = true; themeChangerButton.Text = "DARK MODE"; MainWindow.ActiveForm.BackgroundImage = Properties.Resources.backgroundlight; backButton.Active1 = lightrgbhoverbuttons; backButton.Active2 = lightrgbhoverbuttons; nextButton.Active1 = lightrgbhoverbuttons; nextButton.Active2 = lightrgbhoverbuttons; rookieButton.Active1 = lightrgbhoverbuttons; rookieButton.Active2 = lightrgbhoverbuttons; vrpguiButton.Active1 = lightrgbhoverbuttons; vrpguiButton.Active2 = lightrgbhoverbuttons; shortcutmakerButton.Active1 = lightrgbhoverbuttons; shortcutmakerButton.Active2 = lightrgbhoverbuttons; themeChangerButton.Active1 = lightrgbhoverbuttons; themeChangerButton.Active2 = lightrgbhoverbuttons; LaunchRookie.Active1 = lightrgbhoverbuttons; LaunchRookie.Active2 = lightrgbhoverbuttons; rookiePathOpen.Active1 = lightrgbhoverbuttons; rookiePathOpen.Active2 = lightrgbhoverbuttons; backButton.Inactive1 = lightrgbbuttons; backButton.Inactive2 = lightrgbbuttons; backButton.ForeColor = Color.Black; nextButton.Inactive1 = lightrgbbuttons; nextButton.Inactive2 = lightrgbbuttons; nextButton.ForeColor = Color.Black; rookieButton.Inactive1 = lightrgbbuttons; rookieButton.Inactive2 = lightrgbbuttons; rookieButton.ForeColor = Color.Black; vrpguiButton.Inactive1 = lightrgbbuttons; vrpguiButton.Inactive2 = lightrgbbuttons; vrpguiButton.ForeColor = Color.Black; shortcutmakerButton.Inactive1 = lightrgbbuttons; shortcutmakerButton.Inactive2 = lightrgbbuttons; shortcutmakerButton.ForeColor = Color.Black; themeChangerButton.Inactive1 = lightrgbbuttons; themeChangerButton.Inactive2 = lightrgbbuttons; themeChangerButton.ForeColor = Color.Black; LaunchRookie.Inactive1 = lightrgbbuttons; LaunchRookie.Inactive2 = lightrgbbuttons; LaunchRookie.ForeColor = Color.Black; rookiePathOpen.Inactive1 = lightrgbbuttons; rookiePathOpen.Inactive2 = lightrgbbuttons; rookiePathOpen.ForeColor = Color.Black; minimizeButton.BackColor = lightrgbbuttons; closeButton.BackColor = lightrgbbuttons; minimizeButton.ForeColor = Color.Black; closeButton.ForeColor = Color.Black; contentPanel.BackColor = lightrgbpanels; titleBar.BackColor = lightrgbpanels; contentPanel.ForeColor = Color.Black; label1.ForeColor = Color.Black; welcomeLabel.ForeColor = Color.Black; wikiLink.LinkColor = Color.Black; rookiePathLabel.ForeColor = Color.Black; Properties.Settings.Default.Save(); } else { Properties.Settings.Default.lightModeEnabled = false; themeChangerButton.Text = "LIGHT MODE"; MainWindow.ActiveForm.BackgroundImage = Properties.Resources.backgrounddark; backButton.Active1 = darkrgbhoverbuttons; backButton.Active2 = darkrgbhoverbuttons; nextButton.Active1 = darkrgbhoverbuttons; nextButton.Active2 = darkrgbhoverbuttons; rookieButton.Active1 = darkrgbhoverbuttons; rookieButton.Active2 = darkrgbhoverbuttons; vrpguiButton.Active1 = darkrgbhoverbuttons; vrpguiButton.Active2 = darkrgbhoverbuttons; shortcutmakerButton.Active1 = darkrgbhoverbuttons; shortcutmakerButton.Active2 = darkrgbhoverbuttons; themeChangerButton.Active1 = darkrgbhoverbuttons; themeChangerButton.Active2 = darkrgbhoverbuttons; LaunchRookie.Active1 = darkrgbhoverbuttons; LaunchRookie.Active2 = darkrgbhoverbuttons; rookiePathOpen.Active1 = darkrgbhoverbuttons; rookiePathOpen.Active2 = darkrgbhoverbuttons; backButton.Inactive1 = darkrgbbuttons; backButton.Inactive2 = darkrgbbuttons; backButton.ForeColor = Color.White; nextButton.Inactive1 = darkrgbbuttons; nextButton.Inactive2 = darkrgbbuttons; nextButton.ForeColor = Color.White; rookieButton.Inactive1 = darkrgbbuttons; rookieButton.Inactive2 = darkrgbbuttons; rookieButton.ForeColor = Color.White; vrpguiButton.Inactive1 = darkrgbbuttons; vrpguiButton.Inactive2 = darkrgbbuttons; vrpguiButton.ForeColor = Color.White; shortcutmakerButton.Inactive1 = darkrgbbuttons; shortcutmakerButton.Inactive2 = darkrgbbuttons; shortcutmakerButton.ForeColor = Color.White; themeChangerButton.Inactive1 = darkrgbbuttons; themeChangerButton.Inactive2 = darkrgbbuttons; themeChangerButton.ForeColor = Color.White; LaunchRookie.Inactive1 = darkrgbbuttons; LaunchRookie.Inactive2 = darkrgbbuttons; LaunchRookie.ForeColor = Color.White; rookiePathOpen.Inactive1 = darkrgbbuttons; rookiePathOpen.Inactive2 = darkrgbbuttons; rookiePathOpen.ForeColor = Color.White; minimizeButton.BackColor = darkrgbbuttons; closeButton.BackColor = darkrgbbuttons; minimizeButton.ForeColor = Color.White; closeButton.ForeColor = Color.White; contentPanel.BackColor = darkrgbpanels; titleBar.BackColor = darkrgbpanels; contentPanel.ForeColor = Color.White; label1.ForeColor = Color.White; welcomeLabel.ForeColor = Color.White; wikiLink.LinkColor = Color.White; rookiePathLabel.ForeColor = Color.White; Properties.Settings.Default.Save(); } }
